...
@section('content')
    <div class="min-h-screen">
        <div class="grid lg:grid-cols-2">
            ...
            @endif
            <!-- Form-->
            <div class="px-4 lg:px-[91px] pt-6">
                <!-- Logo Brand -->
                        ...
                        <form action="{{ route('login') }}" class="grid gap-6" method="POST">
                            ...
                            <label class="block">
                                <input type="email"
                                    ...
                                    placeholder="Email Address" id="email" name="email" for="email"
                            ...
                            <label class="block">
                                <input type="password"
                                    class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                                    placeholder="Password" id="password" name="password" for="password" required />
