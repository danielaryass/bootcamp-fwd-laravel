                            ...
                            <section id="basic-tabs-components">
                                ...
                                <ul class="nav nav-tabs text-white">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1"
                                            href="#tab1" aria-expanded="true">Personal Info</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2"
                                            href="#tab2" aria-expanded="false">Change Password</a>
                                    </li>
                                ...
                                <div class="tab-content px-1 pt-1">
                                        ...
                                        <section class="users-edit">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="account" aria-labelledby="account-tab"
                                                    ...
                                                    <form
                                                        action="{{ route('backsite.detail_user.update', Auth::user()->id) }}"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Age"
                                                                    value="{{ Auth::user()->detail_user->age }}"
                                                                    name="age" id="age">
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ route('backsite.dashboard.index') }}"
                                                        class="btn btn-warning " style>Cancel</a>
                                                </div>
                                            </div>
                                            </form>
                                    ...
                                    <div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
                                        <form action="{{ route('backsite.detail_user.changepw', Auth::user()->id) }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
