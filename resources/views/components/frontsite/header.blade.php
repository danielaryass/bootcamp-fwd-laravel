                    ...
                    <div class="hidden lg:ml-10 lg:flex lg:items-center border-l pl-4 pt-2">
                        <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
                            ...
                            <div x-show="profileDekstopOpen" @click.outside="profileDekstopOpen = false"
                                ...
                                tabindex="-1">
                                <a href="{{ route('backsite.detail_user.index') }}"
        ...
        <div class="lg:hidden" id="mobile-menu" x-show="navbarMobileOpen">
            <div class="pt-2 pb-3 space-y-1">
              ...
              -->
                ...
                <a href="#"
                    class="{{ request()->is('appointment') ? 'bg-indigo-50 border-[#0D63F5] text-[#1E2B4F] block pl-3 pr-4 py-2 border-l-4 text-base font-semibold' : 'border-transparent text-[#1E2B4F] hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium' }}">Pricing</a>
            </div>
                ...
                <div x-data="{ profileMobilenOpen: false }" class="pt-4 pb-3 border-t border-gray-200">
                    ...
                    <div x-show="profileMobilenOpen" class="mt-3 space-y-1">
                        ...
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" style="">
                            @csrf
                            <button type="submit"
                                class=" rounded-full text-[#1E2B4F] text-md font-medium bg-[#F2F6FE] px-10 py-3 w-full">Sign
                                Out</button>
                        </form>
